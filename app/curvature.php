...
<meta charset="utf-8">
  ...
  <body>
    ...
    <p>Indicate the curvature type of each worm. 0 - Straight 1 - Stub 2 - C Shape 3 - Corkscrew</p>
    ...
    <tr>
       ...
       <td>
        <select class="selectpicker" data-style="btn-primary" name="A1" required>
          ...
          <option value='2'>2 C shape</option>
...
<td>
  ...
  <?php
    ...
    function test_input($data) {
      ...
      $query = "UPDATE plate SET curvature='$string' WHERE id='$row_id'";
